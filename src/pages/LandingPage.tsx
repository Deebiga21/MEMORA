    ...
    <div className="w-full relative">
      ...
      <nav className="fixed top-0 left-0 right-0 w-full flex justify-between items-center px-8 md:px-12 py-6 z-50">
        <div className="flex items-center gap-2">
          <img src={memoraLogo} alt="MEMORA" className="h-6 object-contain brightness-0 invert opacity-90 hover:opacity-100 transition-opacity duration-300" />
        </div>
